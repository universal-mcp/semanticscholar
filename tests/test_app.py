...
@pytest.fixture
def app_instance():
    """Provides a SemanticscholarApp instance for tests."""
...
def test_universal_mcp_semanticscholar_app_initialization(app_instance):
    """
    Test that the SemanticscholarApp instance is initialized correctly with a name.
    """
    ...
    assert app_instance.name == "semanticscholar", "SemanticscholarApp instance has unexpected name."


def test_universal_mcp_semanticscholar_tool_docstrings_format(app_instance):
    """
    Test that each tool method in SemanticscholarApp has a well-formatted docstring,
...
def test_universal_mcp_semanticscholar_tools_are_callable(app_instance):
    """
    Test that each tool method returned by list_tools in SemanticscholarApp is callable.
    """
    tools = app_instance.list_tools()
    assert isinstance(tools, list), "list_tools() should return a list."
